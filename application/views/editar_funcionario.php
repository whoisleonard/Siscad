                            ...
                            <form action="<?= base_url();?>usuarios/editar_save" method="Post">
                                <div class="card-body">
                                    <h4 class="card-title">Atualizar Funcionario</h4>
                                     <div class="row">
                                         <input type="hidden" class="form-control" id="id" name="id" value="<?= $login[0]->cod_as_usuaria?>">
           <div class="col-md-10">
                ...
                <div class="col-md-2"> 
                    ...
                    <select id="funcao" class="form-control"name="funcao"  required>
                        <option disabled="" selected=""></option>
                         <option value="1"<?= $login[0]->funcao == 1 ? ' selected ' : ''; ?>>Assistente Social</option>
                          <option value="2"<?= $login[0]->funcao == 2 ? ' selected ' : ''; ?>>Advogada</option>
                            <option value="3"<?= $login[0]->funcao == 3 ? ' selected ' : ''; ?>>Psicologa</option>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="txt" class="form-control" id="endereco" name="endereco" value="<?= $login[0]->endereco?>" required>
                    </div>
                </div>
                <div class="col-md-2"> 
                    ...
                    <select id="nivel" class="form-control"name="nivel" required>
                        <option disabled="" selected=""></option>
                         <option value="1"<?= $login[0]->nivel_acesso == 1 ? ' selected ' : ''; ?>>Administrador</option>
                          <option value="2"<?= $login[0]->nivel_acesso == 2 ? ' selected ' : ''; ?>>Usuário</option> 
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <form action="<?= base_url(); ?>Usuarios/salvar_senha" method="post">
                    <input type="hidden" id="id" name="id" value="<?= $login[0]->cod_as_usuaria; ?>">

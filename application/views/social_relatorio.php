                    ...
                    <hr> 
                      <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea type="text" class="form-control" name="h_familiar" weight="256"disabled=""><?= $user['historico_familiar'] ?></textarea>
                            </div>
                          
                     </div>
                      <hr>
                     <h4>Situação Sócio-Econômica</h4>
                    <hr> 
                      <div class="row">
                     ...
                     <hr>
                     <h4>Situação Escolar</h4>
                    <hr> 
                      <div class="row">
                            <div class="form-group col-md-12">
                             
                                <textarea type="text" class="form-control" name="escol" weight="256"disabled=""><?= $user['descricao_escol'] ?></textarea>
                            </div>
                          
                     </div>
                      <hr>
                     <h4>Situação de Moradia</h4>
                    <hr> 
                      <div class="row">
                            <div class="form-group col-md-12">
                             
                                <textarea type="text" class="form-control" name="moradia" weight="256"disabled=""><?= $user['situacao_moradia']; ?></textarea>
                            </div>

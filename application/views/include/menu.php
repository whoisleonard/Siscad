 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i class="fa fa-user"> </i><span class="text"> Bem Vindo, <strong><?php echo $_SESSION['nome'] ;?></strong></span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"  href="<?= base_url(); ?>Dashboard/Tela" aria-expanded="false"><i class="fas fa-home"></i><span class="hide-menu">Tela Inicial</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Atendimento</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?= base_url(); ?>Cadastro_mulher/Cadastro" class="sidebar-link"><i class="fas fa-keyboard"></i><span class="hide-menu"> Cadastro Da Usuária</span></a>
                                    <li class="sidebar-item"><a href="<?= base_url(); ?>Cadastro_mulher/usuarias_arquivadas" class="sidebar-link"><i class="fas fa-keyboard"></i><span class="hide-menu"> Cadastros Arquivados</span></a>
                                </li>
                            </ul>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fab fa-contao"></i><span class="hide-menu">Curso</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-user"></i><span class="hide-menu">Funcionário</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                               ...
                               <li class="sidebar-item"><a href="<?= base_url(); ?>Usuarios/funcionarios_arquivados" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Funcionários Arquivados</span></a></li>
                            </ul>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Relatórios</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="#" data-toggle="modal" data-target="#exampleModalinforma"  class="sidebar-link"><i class="fas fa-file-pdf"></i><span class="hide-menu"> Informativo </span></a></li>
                                <li class="sidebar-item"><a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="sidebar-link"><i class="fas fa-file-pdf"></i><span class="hide-menu"> Social </span></a></li> 
                                <li class="sidebar-item"><a href="<?= base_url(); ?>Relatorio_quanty/filterQ" class="sidebar-link"><i class="fas fa-file-pdf"></i><span class="hide-menu"> Quantitativo </span></a></li>
                            </ul>
                        </li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="namecp" class="col-form-label">Informe Nome ou CPF:</label>
                                <input type="text" class="form-control" id="namecp" name="namecp" placeholder="Nome ou CPF da Usuária..">
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-10">
                                    <label for="namecp">Informe o Nome ou CPF da Usuária:</label>
